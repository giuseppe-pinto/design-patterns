...
import strategy.choices.FirstChoice;
import strategy.choices.IChoice;
import strategy.choices.SecondChoice;
import strategy.contextofchoice.Context;
...
public class StrategyPatternEx
{
  public static void main(String[] args)
  {
    ...
    //Looping twice to test two different strategy.choices
    try
    {
      for (int i = 1; i <= 2; i++)
      {
